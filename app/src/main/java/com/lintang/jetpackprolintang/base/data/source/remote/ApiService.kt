...
interface ApiService {
    ...
    @GET(BuildConfig.MOVIES_API)
    fun getMovies(): Observable<BaseApiModel<List<MovieModel>>>

    @GET(BuildConfig.SERIES_API)
    fun getTvShow(): Observable<BaseApiModel<List<SeriesModel>>>
