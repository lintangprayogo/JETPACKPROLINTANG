...
open class DataDummy {
    ...
    companion object {
        ...
        fun generateMovie(): List<MovieModel> {
        ...
        fun generateSeries(): List<SeriesModel> {
            val serieses = mutableListOf<SeriesModel>()
            serieses.add(
                SeriesModel(
        ...
        fun findMovie(id: String): MovieModel? {
            for (data: MovieModel in generateMovie()) {
        ...
        fun findSeries(id: String): SeriesModel? {
            for (data: SeriesModel in generateSeries()) {
                if (data.id.equals(id)) {
                    return data
                }
            }
