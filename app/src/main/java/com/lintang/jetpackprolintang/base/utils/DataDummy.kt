...
open class DataDummy {
    ...
    companion object {
        ...
        fun generateMovieEntity(): List<MovieEntity> {
        ...
        fun generateSeriesEntity(): List<SeriesEntity> {
            val serieses = mutableListOf<SeriesEntity>()
            serieses.add(
                SeriesEntity(
        ...
        fun generateMovieModel(): List<MovieModel> {
        ...
        fun generateSeriesModel(): List<SeriesModel> {
